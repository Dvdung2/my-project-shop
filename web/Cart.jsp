                                ...
                                <div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                            <c:forEach var="g" items="${vectorCart}">
                                                <tr>
                                                    <th scope="row">
                                                        <div class="p-2">
                                                            ...
                                                            <div class="ml-3 d-inline-block align-middle">
                                                                <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block">${g.getProductName()}</a></h5><span class="text-muted font-weight-normal font-italic"></span>
                                                            </div>
                                                        </div>
                                                    </th>
                                                    <td class="align-middle"><strong>${g.getUnitPrice()}</strong></td>
                                                    <td class="align-middle">
                                                        <a href="#"><button class="btnSub">-</button></a> 
                                                        <strong>${g.getQuantity()}</strong>
