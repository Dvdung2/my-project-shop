                    ...
                    <tbody>
                        <c:forEach var="p" items="${vector}">
                            <tr>
                                ...
                                <td>
                                    <img src="https://canary.contestimg.wish.com/api/webimage/5c4a05a08b26e56dcf17a643-normal.jpg?cache_buster=6d01b751858e14e68932bb234cdc44c1">
                                </td>
                                <td>${p.getUnitPrice()}</td>
                                <td>
                                    <a href="ProductURL?service=updateProduct&pid=${p.getProductID()}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="ProductURL?service=deleteProduct&pid=${p.getProductID()}"  class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="ProductURL" method="post">
                        <input type="hidden" name="service" value="ManageProduct">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                ...
                                <select name="SupplierID" class="form-select" aria-label="Default select example">
                                    <c:forEach var="b" items="${sup}">
                                        <option value=${b.getSupplierID()}>${b.getCompanyName()}</option>
                                    </c:forEach>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="QuantityPerUnit" id="QuantityPerUnit">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="UnitsOnOrder" id="UnitsOnOrder">
                            </div>
                            <div class="form-group">
