                                        ...
                                        <article class="card-body p-5">
                                            ...
                                            <p class="price-detail-wrap"> 
                                                <span class="price h3 text-warning"> 
                                                    <span class="currency">US $</span><span class="num">${product.getUnitPrice()}</span>
                                                </span> 
                                            </p> <!-- price-detail-wrap .// -->
                                            ...
                                            <a href="CartURL?service=add2Cart&pid=${product.getProductID()}" bclass="btn btn-lg btn-outline-primary text-uppercase"> <i class="fas fa-shopping-cart"></i> Add to cart </a>
                                        </article> <!-- card-body.// -->
                                    </aside> <!-- col.// -->
                                </div> <!-- row.// -->
                            </div> <!-- card.// -->
